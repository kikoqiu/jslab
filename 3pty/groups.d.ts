...
declare module "group-utils" {
     ...
     */
    export function createDirectProduct(groupA: PermutationSet, groupB: PermutationSet): PermutationSet;
    /**
...
declare module "group-engine" {
     ...
     * @param {PermutationSet | Array<number>} generators - A PermutationSet or an array of permutation IDs to generate the group from.
     * @returns {PermutationSet} The fully generated subgroup (isGroup=true).
     * @throws {Error} If `generators` is an unknown type.
     */
    export function generateGroup(generators: PermutationSet | Array<number>): PermutationSet;
    export class AbstractGroupSet {
        /**
         ...
         * @abstract
         */
        union(other: AbstractGroupSet): AbstractGroupSet;
        /**
         ...
         * @abstract
         */
        intersection(other: AbstractGroupSet): AbstractGroupSet;
        /**
         ...
         * @abstract
         */
        difference(other: AbstractGroupSet): AbstractGroupSet;
        /**
         ...
         * @abstract
         */
        isSuperSetOf(other: AbstractGroupSet): boolean;
        /**
         ...
         * @abstract
         */
        slice(start: number, end: number): AbstractGroupSet;
        /**
     ...
     * It extends `AbstractGroupSet` and implements its abstract methods.
     */
    export class PermutationSet extends AbstractGroupSet {
        /**
...
declare module "schreier-sims" {
    ...
    export class SchreierSimsAlgorithm {
         ...
         * @static
         */
        static compute(groupSet: PermutationSet, initialBase?: number[]): SchreierSimsAlgorithm;
        /**
...
declare module "group-structural-utils" {
     ...
     * @param {number[]} candidateIds - An array of permutation IDs that are potential generators.
     * @returns {{
     *   fundamental: number[],
     *   redundant: number[],
     ...
     */
    export function analyzeGenerators(candidateIds: number[]): {
        fundamental: number[];
        redundant: number[];
        ssa: SchreierSimsAlgorithm;
    };
...
declare module "group-visualizer" {
     ...
     * @param {number[]} allElementIds - A sorted list of all unique permutation IDs belonging to the group.
     * @param {number[]} generatorIds - A list of permutation IDs that are the fundamental generators of the group.
     ...
     */
    export function generateNames(allElementIds: number[], generatorIds: number[], genLabels?: string[]): Map<number, string>;
    /**
...
declare module "group-visualizer-cayley-graph" {
     ...
     */
    export function generateCayleyGraphForPlotly(inputIds: number[] | PermutationSet, customConfig?: Partial<_CayleyGraphConfig>): CayleyGraphData | {
        data: Array<object>;
        layout: object;
        nameMap: Map<number, string>;
    };
